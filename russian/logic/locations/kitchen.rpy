...
translate russian i_1_023_test_be050fcc:
    ...
    Samantha "А ты угадай. У тебя одна попытка!"
...
translate russian i_1_023_test_08c89910:
    ...
    ch_Name "Нет у меня настроения чай пить..."
...
translate russian i_1_023_test_e246eb6d:
    ...
    Samantha "Хочешь, я попробую с ними поговорить..."
...
translate russian i_1_023_test_12e194a1:
    ...
    ch_Name "Они просто решили, что я работаю просто так, по приколу."
...
translate russian i_1_023_test_df682742:
    ...
    Samantha "Я не могу поверить, что они так сказали! Что на них нашло?"
...
translate russian i_1_023_test_d1cb76e7:
    ...
    ch_Name "Учит меня самостоятельности."
...
translate russian i_1_023_test_cf64e908:
    ...
    Samantha "Подожди-ка. Ты же почти накопил на колледж, какое тебе дело?"
...
translate russian i_1_023_test_4fd49e85:
    ...
    ch_Name "Да они меня до нитки оберут согласно их новому бизнес-плану."
...
translate russian i_1_023_test_f93edfa8:
    ...
    ch_Name "У меня недостаточно денег, чтобы платить одновременно и за аренду, и за обучение."
...
translate russian i_1_023_test_28909970:
    ...
    Samantha "Ты им это сказал? Я уверена, отец бы понял."
...
translate russian i_1_023_test_a9f8e6f1:
    ...
    ch_Name "{i}(Типа, он же не такой ублюдок? Что-то сомневаюсь.){/i}"
...
translate russian i_1_023_test_4c7cf8b1:
    ...
    ch_Name "Не знаю. На данный момент мы не достигли этого понимания."
...
translate russian i_1_023_test_03f5fd66:
    ...
    Samantha "Я чуть не забыла! Ты в почтовый ящик сегодня заглядывал?"
...
translate russian i_1_023_test_51bb9af7:
    ...
    ch_Name "С чего бы я туда заглядывал? Я писем ни от кого не жду."
...
translate russian i_1_023_test_3e555eb1:
    ...
    Samantha "Я точно уверена, что там есть конвертик для тебя."
...
translate russian kitchen_label_2_1ad560a9:
    ...
    ch_Name "Мы еще с ним не закончили."
...
translate russian kitchen_label_2_253c8c6a:
    ...
    ch_Name "Да там ничего особенного."
...
translate russian kitchen_label_2_475303e6:
    ...
    ch_Name "{i}(Интересно, зачем ей понадобилось это дурацкое письмо?){/i}"
...
translate russian kitchen_label_2_f2c90b79:
    ...
    ch_Name "Оу... Ну хоть какая-то от этого письма польза."
